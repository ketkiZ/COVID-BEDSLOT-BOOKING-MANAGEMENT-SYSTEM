...
class BaseForm(FlaskForm):
    ...
    dob = StringField('Date of Birth', validators=[DataRequired(), Regexp(r'^\d{4}-\d{2}-\d{2}$', message='Invalid date of birth')])
...
class SlotBookingForm(BaseForm):
    ...
    spo2 = IntegerField('Spo2', validators=[DataRequired(), NumberRange(min=0, max=100, message='Invalid value. Enter correct percentage of SpO2.')])
